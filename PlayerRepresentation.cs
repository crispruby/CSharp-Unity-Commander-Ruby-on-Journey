...
public class PlayerRepresentation : MonoBehaviour {
    ...
    void ApplyAnimation()
    {
        ...
        // Double Jumping
        if (currentPlayerState == ThirdPersonCharacterController.PlayerState.Dodgeback)
        {
            representationAnimator.SetBool("Dodgeback", true);
        }
        else
        {
            representationAnimator.SetBool("Dodgeback", false);
        }
